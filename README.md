...
### Files and outputs
- Models, checkpoints, and training metadata are saved under `ppo_v1/trainedModels/ALE/Boxing-v5/`
...
To train models in different games/environments, change the `GAME` variable in [ppo_v1/main.py](ppo_v1/main.py) to whichever environment you want to train for.
